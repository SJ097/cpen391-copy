...
//IF YOU CHANGE FONT, REMEMBER TO CHANGE IT IN THREE PLACES. ABOVE ^, BELOW EXTERN, AND INSIDE THE CHARACTER FUNCTION
//BIGGER FONTS MESS UP FOR SOME REASON. Figure this out
...
**
**Inputs: x -> the left beginning area
**Inputs: y -> the top of your text
******************************************************************************************************************************/
...
void OutGraphicsStringFont2(int x, int y, int fontcolour, int backgroundcolour, char* c, int Erase){
	int i;
	for(i = 0; i < strlen(c); i++){
		OutGraphicsCharFont2(x, y, fontcolour, backgroundcolour,c[i],Erase);
		x += FONT2_YPIXELS;
	}
}
