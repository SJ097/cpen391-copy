...
#define Scanner_Register 0x17d0
...
int main() {
	...
	//initialize scanner register to be 0 so you can't scan anything
	IOWR_8DIRECT(Scanner_Register, 0, 0);
	...
	while (1) {
		...
		case 1:
			IOWR_8DIRECT(Scanner_Register, 0, 1);
			clearBtns();
			ScreenOneLoad();
			UpdateGPSBlocking();
			while (state == 1) {
