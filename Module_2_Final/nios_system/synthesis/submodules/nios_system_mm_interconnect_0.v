...
module nios_system_mm_interconnect_0 (
		...
		output wire [1:0]  scanner_register_s1_address,                       //                        scanner_register_s1.address
		output wire        scanner_register_s1_write,                         //                                           .write
		input  wire [31:0] scanner_register_s1_readdata,                      //                                           .readdata
		output wire [31:0] scanner_register_s1_writedata,                     //                                           .writedata
		output wire        scanner_register_s1_chipselect,                    //                                           .chipselect
	...
	wire   [14:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> nios2_qsys_0_jtag_debug_module_agent:cp_channel
	...
	wire   [14:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> HEX0_1_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> HEX4_5_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> HEX2_3_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> timer_1_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> PushButtons_s1_agent:cp_channel
	...
	wire   [31:0] scanner_register_s1_agent_m0_readdata;                                              // scanner_register_s1_translator:uav_readdata -> scanner_register_s1_agent:m0_readdata
	wire          scanner_register_s1_agent_m0_waitrequest;                                           // scanner_register_s1_translator:uav_waitrequest -> scanner_register_s1_agent:m0_waitrequest
	wire          scanner_register_s1_agent_m0_debugaccess;                                           // scanner_register_s1_agent:m0_debugaccess -> scanner_register_s1_translator:uav_debugaccess
	wire   [27:0] scanner_register_s1_agent_m0_address;                                               // scanner_register_s1_agent:m0_address -> scanner_register_s1_translator:uav_address
	wire    [3:0] scanner_register_s1_agent_m0_byteenable;                                            // scanner_register_s1_agent:m0_byteenable -> scanner_register_s1_translator:uav_byteenable
	wire          scanner_register_s1_agent_m0_read;                                                  // scanner_register_s1_agent:m0_read -> scanner_register_s1_translator:uav_read
	wire          scanner_register_s1_agent_m0_readdatavalid;                                         // scanner_register_s1_translator:uav_readdatavalid -> scanner_register_s1_agent:m0_readdatavalid
	wire          scanner_register_s1_agent_m0_lock;                                                  // scanner_register_s1_agent:m0_lock -> scanner_register_s1_translator:uav_lock
	wire   [31:0] scanner_register_s1_agent_m0_writedata;                                             // scanner_register_s1_agent:m0_writedata -> scanner_register_s1_translator:uav_writedata
	wire          scanner_register_s1_agent_m0_write;                                                 // scanner_register_s1_agent:m0_write -> scanner_register_s1_translator:uav_write
	wire    [2:0] scanner_register_s1_agent_m0_burstcount;                                            // scanner_register_s1_agent:m0_burstcount -> scanner_register_s1_translator:uav_burstcount
	wire          scanner_register_s1_agent_rf_source_valid;                                          // scanner_register_s1_agent:rf_source_valid -> scanner_register_s1_agent_rsp_fifo:in_valid
	wire  [106:0] scanner_register_s1_agent_rf_source_data;                                           // scanner_register_s1_agent:rf_source_data -> scanner_register_s1_agent_rsp_fifo:in_data
	wire          scanner_register_s1_agent_rf_source_ready;                                          // scanner_register_s1_agent_rsp_fifo:in_ready -> scanner_register_s1_agent:rf_source_ready
	wire          scanner_register_s1_agent_rf_source_startofpacket;                                  // scanner_register_s1_agent:rf_source_startofpacket -> scanner_register_s1_agent_rsp_fifo:in_startofpacket
	wire          scanner_register_s1_agent_rf_source_endofpacket;                                    // scanner_register_s1_agent:rf_source_endofpacket -> scanner_register_s1_agent_rsp_fifo:in_endofpacket
	wire          scanner_register_s1_agent_rsp_fifo_out_valid;                                       // scanner_register_s1_agent_rsp_fifo:out_valid -> scanner_register_s1_agent:rf_sink_valid
	wire  [106:0] scanner_register_s1_agent_rsp_fifo_out_data;                                        // scanner_register_s1_agent_rsp_fifo:out_data -> scanner_register_s1_agent:rf_sink_data
	wire          scanner_register_s1_agent_rsp_fifo_out_ready;                                       // scanner_register_s1_agent:rf_sink_ready -> scanner_register_s1_agent_rsp_fifo:out_ready
	wire          scanner_register_s1_agent_rsp_fifo_out_startofpacket;                               // scanner_register_s1_agent_rsp_fifo:out_startofpacket -> scanner_register_s1_agent:rf_sink_startofpacket
	wire          scanner_register_s1_agent_rsp_fifo_out_endofpacket;                                 // scanner_register_s1_agent_rsp_fifo:out_endofpacket -> scanner_register_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_014_src_valid;                                                              // cmd_mux_014:src_valid -> scanner_register_s1_agent:cp_valid
	wire  [105:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> scanner_register_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                              // scanner_register_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [14:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> scanner_register_s1_agent:cp_channel
	wire          cmd_mux_014_src_startofpacket;                                                      // cmd_mux_014:src_startofpacket -> scanner_register_s1_agent:cp_startofpacket
	wire          cmd_mux_014_src_endofpacket;                                                        // cmd_mux_014:src_endofpacket -> scanner_register_s1_agent:cp_endofpacket
	...
	wire          scanner_register_s1_agent_rp_valid;                                                 // scanner_register_s1_agent:rp_valid -> router_016:sink_valid
	wire  [105:0] scanner_register_s1_agent_rp_data;                                                  // scanner_register_s1_agent:rp_data -> router_016:sink_data
	wire          scanner_register_s1_agent_rp_ready;                                                 // router_016:sink_ready -> scanner_register_s1_agent:rp_ready
	wire          scanner_register_s1_agent_rp_startofpacket;                                         // scanner_register_s1_agent:rp_startofpacket -> router_016:sink_startofpacket
	wire          scanner_register_s1_agent_rp_endofpacket;                                           // scanner_register_s1_agent:rp_endofpacket -> router_016:sink_endofpacket
	...
	wire   [14:0] to_external_bus_bridge_0_avalon_slave_burst_adapter_source0_channel;                // to_external_bus_bridge_0_avalon_slave_burst_adapter:source0_channel -> to_external_bus_bridge_0_avalon_slave_agent:cp_channel
	...
	wire   [14:0] router_004_src_channel;                                                             // router_004:src_channel -> to_external_bus_bridge_0_avalon_slave_rsp_width_adapter:in_channel
	...
	wire   [14:0] to_external_bus_bridge_0_avalon_slave_rsp_width_adapter_src_channel;                // to_external_bus_bridge_0_avalon_slave_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	...
	wire   [14:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> to_external_bus_bridge_0_avalon_slave_cmd_width_adapter:in_channel
	...
	wire   [14:0] to_external_bus_bridge_0_avalon_slave_cmd_width_adapter_src_channel;                // to_external_bus_bridge_0_avalon_slave_cmd_width_adapter:out_channel -> to_external_bus_bridge_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire   [14:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_004:sink0_channel
	...
	wire   [14:0] rsp_demux_src0_channel;                                                             // rsp_demux:src0_channel -> crosser_002:in_channel
	...
	wire   [14:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink0_channel
	...
	wire   [14:0] rsp_demux_004_src0_channel;                                                         // rsp_demux_004:src0_channel -> crosser_003:in_channel
	...
	wire   [14:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux:sink4_channel
	...
	wire          scanner_register_s1_agent_rdata_fifo_src_valid;                                     // scanner_register_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_014:in_0_valid
	wire   [33:0] scanner_register_s1_agent_rdata_fifo_src_data;                                      // scanner_register_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_014:in_0_data
	wire          scanner_register_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_014:in_0_ready -> scanner_register_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_014_out_0_valid;                                                  // avalon_st_adapter_014:out_0_valid -> scanner_register_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_014_out_0_data;                                                   // avalon_st_adapter_014:out_0_data -> scanner_register_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_014_out_0_ready;                                                  // scanner_register_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_014:out_0_ready
	wire    [0:0] avalon_st_adapter_014_out_0_error;                                                  // avalon_st_adapter_014:out_0_error -> scanner_register_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) scanner_register_s1_translator (
		.clk                    (clocks_sys_clk_clk),                               //                      clk.clk
		.reset                  (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (scanner_register_s1_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (scanner_register_s1_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (scanner_register_s1_agent_m0_read),                //                         .read
		.uav_write              (scanner_register_s1_agent_m0_write),               //                         .write
		.uav_waitrequest        (scanner_register_s1_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (scanner_register_s1_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (scanner_register_s1_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (scanner_register_s1_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (scanner_register_s1_agent_m0_writedata),           //                         .writedata
		.uav_lock               (scanner_register_s1_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (scanner_register_s1_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (scanner_register_s1_address),                      //      avalon_anti_slave_0.address
		.av_write               (scanner_register_s1_write),                        //                         .write
		.av_readdata            (scanner_register_s1_readdata),                     //                         .readdata
		.av_writedata           (scanner_register_s1_writedata),                    //                         .writedata
		.av_chipselect          (scanner_register_s1_chipselect),                   //                         .chipselect
		.av_read                (),                                                 //              (terminated)
		.av_begintransfer       (),                                                 //              (terminated)
		.av_beginbursttransfer  (),                                                 //              (terminated)
		.av_burstcount          (),                                                 //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) scanner_register_s1_agent (
		.clk                     (clocks_sys_clk_clk),                                   //             clk.clk
		.reset                   (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),     //       clk_reset.reset
		.m0_address              (scanner_register_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (scanner_register_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (scanner_register_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (scanner_register_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (scanner_register_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (scanner_register_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (scanner_register_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (scanner_register_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (scanner_register_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (scanner_register_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (scanner_register_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (scanner_register_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (scanner_register_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (scanner_register_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (scanner_register_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (scanner_register_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (scanner_register_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (scanner_register_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (scanner_register_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (scanner_register_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (scanner_register_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (scanner_register_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (scanner_register_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (scanner_register_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (scanner_register_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (scanner_register_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_014_out_0_ready),                    // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_014_out_0_valid),                    //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_014_out_0_data),                     //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_014_out_0_error),                    //                .error
		.rdata_fifo_src_ready    (scanner_register_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (scanner_register_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (scanner_register_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                  //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) scanner_register_s1_agent_rsp_fifo (
		.clk               (clocks_sys_clk_clk),                                   //       clk.clk
		.reset             (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (scanner_register_s1_agent_rf_source_data),             //        in.data
		.in_valid          (scanner_register_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (scanner_register_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (scanner_register_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (scanner_register_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (scanner_register_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (scanner_register_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (scanner_register_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (scanner_register_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (scanner_register_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                // (terminated)
		.csr_read          (1'b0),                                                 // (terminated)
		.csr_write         (1'b0),                                                 // (terminated)
		.csr_readdata      (),                                                     // (terminated)
	...
	nios_system_mm_interconnect_0_router_002 router_016 (
		.sink_ready         (scanner_register_s1_agent_rp_ready),               //      sink.ready
		.sink_valid         (scanner_register_s1_agent_rp_valid),               //          .valid
		.sink_data          (scanner_register_s1_agent_rp_data),                //          .data
		.sink_startofpacket (scanner_register_s1_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (scanner_register_s1_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clocks_sys_clk_clk),                               //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clocks_sys_clk_clk),                               // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (scanner_register_s1_agent_rdata_fifo_src_data),    //     in_0.data
		.in_0_valid     (scanner_register_s1_agent_rdata_fifo_src_valid),   //         .valid
		.in_0_ready     (scanner_register_s1_agent_rdata_fifo_src_ready),   //         .ready
